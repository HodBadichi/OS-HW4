...
int main() {
    ...
    assert(tail() == (MallocMetaData*)p4 - 1);
    ...
    assert(tail() == (MallocMetaData*)p1 - 1);
    assert(blocks_list_head == (MallocMetaData*)p1 - 1);
    ...
    assert(tail() == (MallocMetaData*)p6 - 1);
    assert(blocks_list_head == (MallocMetaData*)p1 - 1);
    p5 = smalloc(1000);
    ...
    assert(tail() == (MallocMetaData*)p7 - 1);
    assert(blocks_list_head == (MallocMetaData*)p1 - 1);
